		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwind dynamic forms",
									"targetURL": "#comibsdynamicform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsdynamicform-display": {
								"semanticObject": "comibsdynamicform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.dynamicform",
									"url": sap.ui.require.toUrl("com/ibs/dynamicform")
								}
							}
						}
					}
